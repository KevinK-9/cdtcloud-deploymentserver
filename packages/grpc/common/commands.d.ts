            ...
            cli: {
                commands: {
                    v1: {
                        ...
                        ArduinoCoreService: SubtypeConstructor<typeof grpc.Client, _cc_arduino_cli_commands_v1_ArduinoCoreServiceClient> & {
                            service: _cc_arduino_cli_commands_v1_ArduinoCoreServiceDefinition;
                        };
